...
flag="--root_dir ${DATA_ROOT}
      ...
      --max_action_len 15
      --max_instr_len 200
      --train_env_names directions_gpt4o_train_wo_panorama_id_modified
      --val_env_names val_seen val_unseen directions_gpt4o_val_seen_wo_panorama_id_modified directions_gpt4o_val_unseen_wo_panorama_id_modified 
