...
def _get_qwen_model(model="Qwen2.5-VL-7B-Instruct"):
    ...
    if model == "Qwen2.5-VL-7B-Instruct":
        _qwen_model_dir = "/.cache/huggingface/hub/models--Qwen--Qwen2.5-VL-7B-Instruct/snapshots/5b5eecc7efc2c3e86839993f2689bbbdf06bd8d4"
        print("Loading Qwen2.5-VL-7B-Instruct model...")
    elif model == "Qwen2.5-VL-32B-Instruct":
        _qwen_model_dir = "/.cache/huggingface/hub/models--Qwen--Qwen2.5-VL-32B-Instruct/snapshots/6bcf1c9155874e6961bcf82792681b4f4421d2f7"
        # os.environ["FLASH_ATTENTION_2_ENABLED"] = "0"
        print("Loading Qwen2.5-VL-32B-Instruct model...")
    elif model == "Qwen/Qwen2.5-7B-Instruct":
            _qwen_model_dir = "/.cache/huggingface/hub/models--Qwen--Qwen2.5-7B-Instruct/snapshots/a09a35458c702b33eeacc393d103063234e8bc28"
...
def get_intern_model(model_name="OpenGVLab/InternVL3-8B"):
    if model_name == "OpenGVLab/InternVL3-8B":
        model_dir = "/.cache/huggingface/hub/models--OpenGVLab--InternVL3-8B/snapshots/26dcadeb50cde4369918519c760feb2946814e10"
    else:
...
if __name__ == "__main__":
    ...
    instructions = ["Turn left until you see a white hall with colorful paintings. Walk up the stairs after you turning left. Stop by the middle of the stairs.", "Exit the stairs, and then make a right. Walk straight for a few feet and then make a right. Walk straight until you reach the pool table and then wait there."]
