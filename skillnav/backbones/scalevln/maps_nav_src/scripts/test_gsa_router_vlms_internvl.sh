...
VAL_ENV_NAMES=${VAL_ENV_NAMES:-"val_residential_basic val_non_residential_basic val_non_residential_scene val_residential_user val_non_residential_user"}

AGENT_GPU="${1:-2}"
ROUTER_HOST="${ROUTER_HOST:-127.0.0.1}"
ROUTER_PORT="${ROUTER_PORT:-8012}"
ROUTER_MODEL_NAME="${ROUTER_MODEL_NAME:-OpenGVLab/InternVL3_5-8B}"
