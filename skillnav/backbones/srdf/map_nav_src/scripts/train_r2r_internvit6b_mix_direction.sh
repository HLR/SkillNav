...
name=${name}-aug.mp3d.hm3d.srdf.direction-2k
...
CUDA_VISIBLE_DEVICES=$1 python r2r/main_nav.py $flag  \
      ...
      --iters 60000 \
      --train_env_names train original_direction_gpt4o_train_2k \
      --val_env_names val_seen val_unseen \
      # --resume_file ../datasets/exprs_map/finetune/dagger-internvit.6b-seed.0-aug.mp3d.hm3d.srdf.reordering.direction-2k/ckpts/latest_dict
      # --batch_size 32
