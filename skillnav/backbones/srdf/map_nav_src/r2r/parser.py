...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='r2r', choices=['r2r', 'r4r', 'rxr', 'gsa-r2r'])
    ...
    parser.add_argument('--test_iters', type=int, default=None, help='test iterations')
...
def postprocess_args(args):
    ...
    ft_file_map = {
        ...
        'clip.b16': 'clip_vit-b16_mp3d_hm3d_gibson.hdf5',
        # 'internvit.6b': 'internvit_6b_fov60_mp3d_panogen.hdf5',
        'internvit.6b': 'internvit_6b_fov60_mp3d_hm3d.hdf5'
    }
    ...
    if args.features == 'clip.h14':
        ...
        # args.mp3d_ft_files = [os.path.join(ROOTDIR, 'R2R', 'features', 'clip_vit-b16_mp3d_hm3d_gibson.hdf5')]
        # args.val_ft_file = os.path.join(ROOTDIR, 'R2R', 'features', 'clip_vit-b16_mp3d_hm3d_gibson.hdf5')
    elif args.features =='internvit.6b':
        args.aug_ft_file = os.path.join(ROOTDIR, 'SRDF', 'features', ft_file_map[args.features])
        if args.dataset == 'r2r':
            args.mp3d_ft_files = [os.path.join(ROOTDIR, 'SRDF', 'features', 'internvit_6b_fov60_mp3d.hdf5')]
            args.val_ft_file = os.path.join(ROOTDIR, 'SRDF', 'features', 'internvit_6b_fov60_mp3d.hdf5')
        else:
            args.mp3d_ft_files = [os.path.join(ROOTDIR, 'SRDF', 'features', ft_file_map[args.features])]
            args.val_ft_file = os.path.join(ROOTDIR, 'SRDF', 'features', ft_file_map[args.features])
    ...
    # args.ckpt_dir = "/home/matiany3/ScaleVLN/VLN-DUET/datasets/R2R/trained_models/finetune"
