...
import r2r.agent_base as agent_base
...
from utils.get_images import load_vp_lookup


class GMapNavAgentSubmit(Seq2SeqAgent):
    ...
    def __init__(self, args, env, rank):
        ...
        if self.args.log_dir:
            ...
            # Set up logger
            if self.args.debug:
                log_file_path = os.path.join(self.args.log_dir, "debug_outputs.log")
            else:
                log_file_path = os.path.join(self.args.log_dir, "outputs.log")
    ...
    def make_equiv_action(self, a_t, gmaps, obs, traj=None):
        ...
        for i, ob in enumerate(obs):
            ...
            if action is not None:            # None is the <stop> action
                ...
                # Append heading and elevation for each step
