...
CUDA_VISIBLE_DEVICES=$1 python moe/main_nav_moe_top1.py $flag  \
        ...
        --routing_mode top1 \
        --instruction_reorder \
        --resume_files  ${DATA_ROOT}/R2R/exprs_map/finetune/dagger-clip.b16-seed.0-aug.mp3d.prevalent.temporal-aug.direction-resized-pretrained/ckpts/best_val_unseen \
                        ...
                        ${DATA_ROOT}/R2R/trained_models/finetune/duet_vit-b16_ft_best_val_unseen test_non_residential_scene\
        --resume_weights 1 1 1 1 1 0 0 \
        --val_env_names test_residential_basic test_non_residential_basic \
